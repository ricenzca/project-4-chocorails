...
class PromosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post promos_url, params: { promo: { discount: @promo.discount, unique_id: @promo.unique_id } }
    end
  ...
  test "should update promo" do
    patch promo_url(@promo), params: { promo: { discount: @promo.discount, unique_id: @promo.unique_id } }
