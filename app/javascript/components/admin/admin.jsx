  ...
  render(){
        ...
        return (
            <tr>
                ...
                <td> <a href={"/customers/" + (index+1) + "/edit"}> <button className="btn btn-outline-info"> Edit Customer </button> </a> </td>
            </tr>
            )
    });
        ...
        return (
            ...
            <td> <a href={"/orders/" + (index+1) + "/edit"}> <button className="btn btn-outline-info"> Edit Order </button> </a> </td>
            </tr>
            )
    });
        ...
        return (
            ...
            <td> {promo.used} </td>
            <td> <a href={"/promos/" + (index+1) + "/edit"}> <button className="btn btn-outline-info"> Edit Promo </button> </a> </td>
            </tr>
            )
    });
        ...
        return (
            ...
            <td> <a href={"/products/" + (index+1) + "/edit"}> <button className="btn btn-outline-info"> Edit Product </button> </a> </td>
            </tr>
            )
    });

    return( <React.Fragment>
        <div style={{backgroundColor:'', color:'black', padding: 8}}>
